    ...
    $.ajax({url: controlador,
            ...
            success:function(respuesta){
                ...
                if (pacientes != null){
                    ...
                    for(var i = 0; i < n ; i++){
                        html += "<tr onclick='este_pacientesesionesmodif("+JSON.stringify(pacientes[i])+"); ocultar_tabla()' style='cursor: pointer'>";
...
*/
function este_pacientesesionesmodif(paciente)
{
                ...
                success:function(respuesta){
                    ...
                    if (sesiones != null){
                        //if(sesiones[0]["sesion_id"] > 0){
                            ...
                            html += "<tbody class='buscar'>";
                            for(var i = 0; i < n ; i++){
                                html += "<tr onclick='ir_adetalleprocedimientomodif("+sesiones[i]["sesion_id"]+"); ocultar_tabla()' style='cursor: pointer'>";
                                html += "<td class='text-center'>"+(i+1)+"</td>";
...
function ir_adetalleprocedimientomodif(sesion_id){
    let base_url = document.getElementById('base_url').value;
    let dir_url  = base_url+"sesion/modificarmodif/"+sesion_id;
