...
<td style="padding: 0;">
            ...
            <table class="table" style="width: <?php echo $ancho;?>cm; padding: 0;" >
                ...
                <center>
                    ...
                    <img src="<?php echo base_url('resources/images/empresas/').$empresa['empresa_imagen']; ?>" width="80px" height="60px"><br>
                    <font size="3" face="Arial"><b><?php echo $empresa['empresa_nombre']; ?></b></font><br>
                    <font size="1" face="Arial"><?php echo $empresa['empresa_direccion']; ?></font><br>
                    <font size="1" face="Arial"><?php echo $empresa['empresa_telefono']; ?></font><br>
