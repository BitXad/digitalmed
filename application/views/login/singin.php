...
<head>
    <title>PruebasLab :: Sistema de administración de laboratorios</title>
...
<?php } ?>
    ...
    <div class="login-page" style="background-image: url(<?php echo base_url("resources/images/fondo.jpg"); ?>); background-repeat: no-repeat;background-size: cover; ">
        ...
        <div class="login-head">
          <!--<h2 class="text-center"><?php echo $empresa["empresa_nombre"] ?></h2>-->
          <center>
              <font size="5" face="Arial black"><b><?php echo $empresa["empresa_nombre"] ?></b></font><br>              
                <img src="<?php echo base_url('resources/images/empresas/'.$empresa["empresa_imagen"].''); ?>"  style="width:80px;height:80px">
            ...
            <div class="w3_footer_grids">
                <div class="col-md-3 w3_footer_grid">
                    <center>
                        <a href="<?php echo base_url("website/ximpleman"); ?>" target="_BLANK" >
                            <img src="<?php echo base_url("resources/images/logo.png"); ?>" width="50%" height="50%">
                        </a>
                    </center>
                </div>
                <div class="col-md-3 w3_footer_grid">
                ...
                <div class="col-md-3 w3_footer_grid">
                    <center>
                        ...
                        <img src="<?php echo base_url("resources/images/logo_password.png"); ?>" width="50%" height="50%">
                        </a>
                    </center>
                </div>
                <div class="clearfix"> </div>
