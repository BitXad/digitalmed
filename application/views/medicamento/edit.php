    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Medicamento Edit</h3>
           ...
           <div class="col-md-6">
               <label for="medicamento_id" class="control-label">  <span class="text-danger"></span>MEDICAMENTO ID</label>
                <div class="form-group">
                  <input type="text" name="medicamento_id" value="<?php echo ($this->input->post('medicamento_id') ? $this->input->post('medicamento_id') : $medicamento['medicamento_id']); ?>" class="form-control" id="medicamento_id" />
               ...
               <label for="medicamento_nombre" class="control-label">  <span class="text-danger"></span>NOMBRE</label>
                <div class="form-group">
                  <input type="text" name="medicamento_nombre" value="<?php echo ($this->input->post('medicamento_nombre') ? $this->input->post('medicamento_nombre') : $medicamento['medicamento_nombre']); ?>" class="form-control" id="medicamento_nombre" />
               ...
               <label for="medicamento_forma" class="control-label">  <span class="text-danger"></span>FORMA</label>
                <div class="form-group">
                  <input type="text" name="medicamento_forma" value="<?php echo ($this->input->post('medicamento_forma') ? $this->input->post('medicamento_forma') : $medicamento['medicamento_forma']); ?>" class="form-control" id="medicamento_forma" />
               ...
               <label for="medicamento_concentracion" class="control-label">  <span class="text-danger"></span>CONCENTRACION</label>
                <div class="form-group">
                  <input type="text" name="medicamento_concentracion" value="<?php echo ($this->input->post('medicamento_concentracion') ? $this->input->post('medicamento_concentracion') : $medicamento['medicamento_concentracion']); ?>" class="form-control" id="medicamento_concentracion" />
